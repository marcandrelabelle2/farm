const veges = {
  delivery: "Livraison de légumes",
  dlvinfo:
    "Informez-vous de ce qui est disponible cette saison \
     et sur les variétés qui peuvent être livré à votre restaurant",
  delivbutton: "Livraison",
